...
const { getAllEmployees, getProfile, updateEmployee, getEmployeeById, createLeaveRequest, updateLeaveRequest, getEmployeeLeaves, createEmployee} = require("../controllers/employeeController");
